      ...
      <div className="space-y-2">
        ...
        {filteredContacts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-muted-foreground mb-1">No contacts found</h3>
            <p className="text-sm text-muted-foreground">
              {searchQuery ? "Try adjusting your search or filter." : "Contacts will appear here once connected."}
            </p>
          </div>
        )}
      </div>
